        ...
        <div class="col-md-10">
          <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
              ...
              <h2 id="feedbak-header" class="mb-5">Feeback Form <br></h2>
              <form onsubmit="return feedbackvalidate();">
                ...
                <div class="row">
                  <div class="col-md-12 form-group">
                    <textarea class="form-control" name="feedbackmassage" id="feedbackmassage" cols="30" rows="7"
            ...
            <div class="col-lg-4 ml-auto">
              <h3 id="lets" class="mb-4">Let's talk about everything.</h3>
              <p id="feed-para">We value your input and are eager to hear your thoughts and suggestions on how we can
                enhance our service to better serve you. Your feedback is instrumental in helping us improve and provide
                an even more enjoyable experience during your visits to INOX. Please take a moment to share your
                thoughts with us so that we can continue to exceed your expectations. Your satisfaction is our utmost
                priority, and we appreciate the opportunity to learn and grow with your valuable feedback. Thank you for
                choosing INOX, and we look forward to hearing from you.</p>
