            ...
            if (mysqli_num_rows($result) > 0) {
              while ($row = mysqli_fetch_array($result)) {
                ...
                <tr>
                  ...
                  <td><a href="app/delete_account.php?id=<?php echo $row['id'] ?>"> <button data-toggle="modal"
                        data-target="#delete_show<?php echo $row['id']; ?>" class="btn btn-danger btn-sm">Delete
                        Account</button></a>
                  </td>
                </tr>

                <div class="modal fade" id="delete_users_modal<?php echo $row['id']; ?>" tabindex="-1" role="dialog"
