...
<body>
    ...
    <div id="booking-container">
        <div class="seat_heading">
            <h3>
                <center>BOOK YOUR SEAT NOW</center>
            </h3>
        </div>
        <?php
        ...
        <form method="post">
            <?php
            // Initialize an empty array to hold the seat values
            $seats = [];

            // Fetch the rows and append each seat to the array
            ...
            <!-- Use the generated string as the value of the hidden input -->
            <input type="hidden" name="t1" value="<?php echo htmlspecialchars($seats_str, ENT_QUOTES, 'UTF-8'); ?>">

            <center>
                <input id="check-available-seat" type="submit" name="submit" class="btn btn-primary"
                    value="Check Available Seat">
            </center>
        </form>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="seatCharts-container">
                                ...
                                <div id="screen-txt" class="front">SCREEN</div>
                                <center>
                                    <p id="notvalid" style="color: red; font-size: 20px;"></p>
                                </center>
                                        ...
                                        <div class="seattable" id="silver">
                                            <table>
                                                <tr>
                                                    ...
                                                    ?>></td>
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="I10"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="I11"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="I12"
                                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    ?>></td>
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="H10"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="H11"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="H12"
                                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    ?>></td>
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="G10"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="G11"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="G12"
                                                            <?php
                                        ...
                                        <div class="seattable" id="gold">
                                            <table>
                                                <tr>
                                                    ...
                                                    ?>></td>
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="F10"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="F11"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="F12"
                                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    ?>></td>
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="E10"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="E11"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="E12"
                                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    ?>></td>
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="D10"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="D11"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="D12"
                                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    ?>></td>
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="C10"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="C11"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="C12"
                                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    ?>></td>
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="B10"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="B11"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="B12"
                                                            <?php
                                        ...
                                        <div class="seattable">
                                            <table>
                                                <tr>
                                                    ...
                                                    ?>></td>
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="A10"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="A11"
                                                            <?php
                                                    ...
                                                    <td><input type="checkbox" class="larger" name="seat[]" value="A12"
                                                            <?php
                        ...
                        <div class="col-lg-6">
                            ...
                            <table id="seat-deat">
                                <tr>
                                    <td width="50%">
                                        <font class="right-txt">Movie:</font>
                                    </td>
                                    <td bgcolor="79F9E2">
                                        <center>
                                            <label class="right-right-txt"><?php echo $_GET['movie']; ?></label>
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%">
                                        <font class="right-txt">Time:</font>
                                    </td>
                                    <td bgcolor="ECF68C">
                                        <center>
                                            <label class="right-right-txt"><?php echo $_GET['time']; ?></label>
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%">
                                        <font class="right-txt">Seat:</font>
                                    </td>
                                    <td id="right-right-input-container-1"> <input class="right-right-input" type="text"
                                            id="selectedtext" name="seats" placeholder="selected checkboxs">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="50%">
                                        <font class="right-txt">Total Seat:</font>
                                    </td>
                                    <td id="right-right-input-container-2"> <input class="right-right-input type=" text"
                                            id="count" name="totalseat" placeholder="Total Seats"></td>
                                </tr>
                            ...
                            <div id="parking-container">
                                <label for="parking">Reserve a parking slot?</label>
                                ...
                                <div id="vehicle-container">
                                    ...
                                    <select name="vehicle" id="vehicle">
                                        ...
                                        <option value="minivans">Minivan</option>
                            ...
                            if (!isset($_SESSION['uname'])) {
                                ?>
                                <div id="payment-now-main-container" class="col-lg-12">
                                    <div id="payment-now-container" class="form-group">
                                        <a id="payment-now" data-toggle="modal" data-target="#tailer_modal"
                                ...
                                <div id="payment-now-main-container" class="col-lg-12">
                                    <div id="payment-now-container" class="form-group">
                                        <input id="payment-now" type="submit" value="Payment Now" name="submit"
                                            class="form-control btn btn-primary py-2">
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        parking.addEventListener('change', function () {
            if (this.checked) {
                document.getElementById('vehicle-container').style.visibility = 'visible';
            } else {
                document.getElementById('vehicle-container').style.visibility = 'hidden';
            }
        });
